...
<center>
 ...
 <br> <br>
<h2>Provider Register Here</h3></h2>
<center>
 <form action="pregister1.jsp" method="get"    >
...
<table align="center" cellpadding="5" cellspacing="5" width="400">
			  <tr> 
                <td><font size="+1"color=#006666><strong>Company Name</strong>*</font>
				<br>
				<input  class="form-control" type="text" name="cname" id = "addr" onblur = "enableRegisterButton();" style="width: 500px;"	required >
              </tr>
              <tr> 
               </table>
<table align="center" cellpadding="5" cellspacing="5" width="400">
			  <tr> 
                <td><font size="+1"color=#006666><strong>Description about company</strong>*</font>
				<br>
				<input  class="form-control" type="text" name="des" id = "addr" onblur = "enableRegisterButton();" style="width: 500px;"	required >
              </tr>
              <tr> 
               </table>
